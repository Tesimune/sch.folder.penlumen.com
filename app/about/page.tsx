          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                At Optimum Achievers Academy, our mission is to provide a world-class education that empowers students
                to become confident, capable, and compassionate leaders. We believe in nurturing academic excellence,
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                We envision a community of learners who are curious, innovative, and committed to making a positive
                impact on the world. Our students will be well-rounded individuals equipped with the skills and
